...
class UserPasswordChangeForm(PasswordChangeForm):
    ...
    new_password1= forms.CharField(label='Новый пароль 1', widget=forms.PasswordInput(attrs={'class':'form-input'}))
    new_password2=forms.CharField(label='Новый пароль 2', widget=forms.PasswordInput(attrs={'class':'form-input'}))
